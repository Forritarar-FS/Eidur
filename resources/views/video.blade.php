...
<div class="row">
  <h1 class="title col-sm-offset-1" style="font-weight: bold;">Video Posts</h1>
  <div>
    <hr/>
      ...
      <ul id="posts">
        <div class="col-sm-11 col-lg-5 col-md-offset-1">
          ...
          <div id="content" class="panel panel-default">
            ...
            <div style="hidden; overflow: hidden;" class="panel-body"><a style="font-weight: bold;" href="{{ action('PostsController@video', [$post->id]) }}"><img class="img-responsive" style="width: 100%" src="{{ $post->fileToUpload }}"></a></div>
        ...
        <div class="hidden-xs hidden-sm col-sm-offset-4 col-sm-4 col-sm-offset-1">
          <a href="{{ url('/') }}" ><button type="button" class="btn btn-default btn-lg btn-block">Trending</button></a>
    		  ...
    		  <a href="{{ url('/cosplay') }}"><button type="button" class="btn btn-default btn-lg btn-block">Cosplay</button></a>
    			<a href="{{ url('/nsfw') }}"><button type="button" class="btn btn-default btn-lg btn-block list-group-item">NSFW (18+)</button></a>
