        ...
        <hr>
          ...
          <div style="margin-top: 50px;" class="container col-sm-8 col-sm-offset-3 col-md-9 col-md-offset-2 col-xs-8 col-xs-offset-3">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">Edit Your Display Name</div>

              <div class="panel-body">
                {!! Form::open(['url' => 'profile/name']) !!}
                  <div class="from-group">
                    {!! Form::label('body', 'Edit your display name: ') !!}
                    {!! Form::text('name', null, ['class' => 'form-control']) !!}<br>
                    <br>
                    {!! Form::submit('Change Name', ['class' => 'btn btn-default btn-lg btn-block', 'accept' => 'image/gif', 'onclick' => 'submitForm(this)']) !!}
                  </div>
                {!! Form::close() !!}
              </div>
            </div>
