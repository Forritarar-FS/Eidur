              ...
              <div class="panel-body">
                {!! Form::open(['url' => 'profile/password']) !!}
                  <div class="from-group">
                    {!! Form::label('body', 'Edit your password: ') !!}
                    ...
                    {!! Form::submit('Change Password', ['class' => 'btn btn-default btn-lg btn-block', 'name' => 'submit', 'accept' => 'image/gif', 'onclick' => 'submitForm(this)']) !!}
                  </div>
                {!! Form::close() !!}
              </div>
            </div>
